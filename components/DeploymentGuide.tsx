...
export const DeploymentGuide: React.FC<DeploymentGuideProps> = ({ onNext }) => {
  return (
    <div className="max-w-4xl mx-auto py-16 px-6 bg-[#363020]">
      <div className="mb-12">
        <h2 className="text-4xl font-black mb-4 text-white">Part 4: GCP Deployment Strategy</h2>
        <p className="text-[#6e7e85] text-lg">Launching for the first 100 operators with high reliability.</p>
      </div>
      ...
      <div className="space-y-12">
        <div className="grid md:grid-cols-2 gap-8">
          <section className="bg-[#363020]/80 border border-[#4c934c]/30 rounded-2xl p-8">
            ...
            <p className="text-sm text-[#6e7e85] mb-6 font-medium">Best for the React Landing Page.</p>
            <div className="bg-[#363020] p-4 rounded-lg font-mono text-xs text-[#91cb3e]">
              # 1. Install CLI<br/>
          ...
          <section className="bg-[#363020]/80 border border-[#4c934c]/30 rounded-2xl p-8">
            ...
            <p className="text-sm text-[#6e7e85] mb-6 font-medium">Best for dynamic admin verification logic.</p>
            <div className="bg-[#363020] p-4 rounded-lg font-mono text-xs text-[#91cb3e]">
              # 1. Build Image<br/>
        ...
        <section className="bg-[#363020]/80 border border-[#4c934c]/30 rounded-2xl p-8">
          <h3 className="text-xl font-bold mb-6 text-[#91cb3e]">Launch Checklist</h3>
          <div className="grid md:grid-cols-2 gap-8">
            <ul className="space-y-3 text-[#6e7e85] text-sm">
